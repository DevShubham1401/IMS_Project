...
<head>
    ...
    <style>
        * {
        ...
        .main {
            width: 100%;
            background: url("Images/slider-img2.jpg");
...
<body>
    <div class="main">
        ...
        <div class="content">
            <h1>Welcome to <br><span>Life Insurance</span></h1>
            <p class="para">For every offense you encounter, you need someone to defend your life.</p>
